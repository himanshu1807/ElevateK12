...
public class Flipkart2 {
	...
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\Flipkart1\\chromedriver.exe");
		...
		driver.findElement(By.xpath("//*[contains(@href,'suggestionId=samsung+mobiles')]")).click();
		
		WebElement mainmenu = driver.findElement(By.xpath("//*[@alt='Mobiles']"));
		mainmenu.click();
